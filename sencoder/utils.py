...
def inspect(model, X, frame_rate=4, insp_keys={}, batch_size=None, to_numpy=True, verbose=False):
    """
...
def shuffle_array(arr, inplace=False):
    """
    Returns a new array in which the contents of arr have been shuffled.
